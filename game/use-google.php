<?php
  ...
  $prev_path = "password-is-templar.php";
  $cur_path = "use-google.php";
      ...
      <div class="small-12 columns">
        <div class="block">
          <div class="centered">
            ...
            <div style="margin-top:10px;">Lorem ipsum dolor sit amet, consectetur ????? elit,<br>sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
